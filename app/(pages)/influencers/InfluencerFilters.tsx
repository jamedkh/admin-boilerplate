  ...
  return (
    <Drawer>
      <DrawerTrigger asChild>
        <Button
          variant={"secondary"}
          className="rounded-sm w-10 h-10 bg-transparent hover:text-muted-foreground"
        >
        ...
        <ScrollArea className="h-[350px] w-full pr-4">
          <div className="grid grid-cols-12 gap-4 m-3 py-3">
            <div className="lg:col-span-3 col-span-12">
              ...
              <Select>
                <SelectTrigger className="w-full dark:bg-zinc-900 py-2 px-5 text-start rounded-sm flex justify-between border items-center hover:bg-accent text-sm font-medium">
